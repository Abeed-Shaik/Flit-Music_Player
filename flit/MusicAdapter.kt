...
import com.abeed.flit.databinding.DetailsViewBinding
import com.abeed.flit.databinding.MoreFeaturesBinding
import com.abeed.flit.databinding.MusicViewBinding
...
class MusicAdapter(private val context: Context, private var musicList: ArrayList<Music>, private val playlistDetails: Boolean = false,
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .apply(RequestOptions().placeholder(R.drawable.abticon).centerCrop())
            .into(holder.image)
