...
import com.abeed.flit.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(themeIndex == 4 &&  resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_NO)
            Toast.makeText(this, "Turn ON Dark Mode...While using Black Theme !!", Toast.LENGTH_LONG).show()
        ...
        binding.shuffleBtn.setOnClickListener {
            if (musicAdapter.itemCount == 0){
                Toast.makeText(this,"There are no Songs available on your device to Shuffle.",Toast.LENGTH_LONG).show()
            } else {
        ...
        binding.navView.setNavigationItemSelectedListener{
            when(it.itemId)
            {
                ...
                R.id.navPrivacy -> {
                    ...
                    intent.data = Uri.parse("https://asitro.blogspot.com/2022/12/flit-privacy-policy.html")
                    startActivity(intent)
                }
                R.id.navExit -> {
    ...
    private fun popUp() {
        val snackbar = Snackbar.make(findViewById(android.R.id.content),"App Update Almost Done.",
