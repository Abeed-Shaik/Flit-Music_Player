...
import com.abeed.flit.databinding.ActivityPlayerBinding
import com.abeed.flit.databinding.AudioBoosterBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.data?.scheme.contentEquals("content")){
            ...
            Glide.with(this)
                ...
                .apply(RequestOptions().placeholder(R.drawable.icon_flit).centerCrop())
    ...
    private fun createMediaPlayer(){
        ...
        }catch (e: Exception){Toast.makeText(this, "Song Format not Supported!!", Toast.LENGTH_LONG).show()}
    }
